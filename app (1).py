...
GROQ_MODELS = {
    ...
    "GPT-OSS 120B (OpenAI open model)": "openai/gpt-oss-120b",
...
with st.sidebar:
    ...
    st.caption(
        ...
        "Paste your own free Groq API key below — it stays in your "
    ...
    st.divider()
    st.caption("Built with Streamlit · Powered by Groq (free tier)")
